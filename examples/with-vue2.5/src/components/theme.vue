...
export default {
  ...
  mounted: () => {
    ...
    theme = new Theme({
      ...
      accessToken:
        "at.83jbbwt02uf2e3z439l15j26a6tt0nii-2rvibsbk7l-1ui9xu3-hf5osf52z",
      ...
      volumeOptions: {
        ...
        onOpenChange: (open, volume, muted) => {
          console.warn(
            "[theme.html theme volumeOptions onOpenChange] open: ",
            open,
            "volume: ",
            volume,
            "muted:",
        ...
        onChange: (volume, muted) => {
          console.warn(
            "[theme.html theme volumeOptions onChange]",
            "volume: ",
            volume,
            "muted:",
            muted
