...
declare const THEME_PROPS: readonly [
  "width",
  "height",
  "playing",
  "volume",
 ...
 * @typeParam T - 控件配置项
 */
type OmitControlOptions<T extends ControlOptions> = Omit<
  T,
  | "rootContainer"
  | "getPopupContainer"
  | "classNameSuffix"
 ...
 * 加载动画控件配置项
 */
interface LoadingOptions extends Omit<
  ControlOptions,
  "tagName" | "controlType"
> {
  /**
 ...
 * 消息控件配置项
 */
interface MessageOptions extends Omit<
  ControlOptions,
  "tagName" | "controlType"
> {
...
declare class Utils {
  ...
  static orientationEventListener(
    change?: OrientationChangeCallback,
  ): [ScreenOrientation, CleanUpScreenOrientationFun];
  /**
